	...
	"type": ["string", "number"]
            ...
            <section title="additionalProperties" anchor="additionalProperties">
                <t>This attribute specifies how any instance property that is not explicitly defined by either the
                    ...
                    attributes (hereafter referred to as "additional properties") is handled. If specified, the value
            ...
            <section title="items" anchor="items">
                ...
                <t>When this attribute value is an array of schemas and the instance value is an array, each position in
                    ...
                    disallowed, or constrained by the
            ...
            <section title="additionalItems" anchor="additionalItems">
                <t>This attribute specifies how any item in the array instance that is not explicitly defined by
                    ...
                    (hereafter referred to as "additional items") is handled. If specified, the value MUST be a schema
                    or a boolean.
                </t>
                <t>If a schema is provided:
                    <list>
                        <t>If the
                            <xref target="items">"items"</xref>
                            attribute is unspecified, then all items in the array instance must be valid against this
                            schema.
                        </t>
                        <t>If the
                            <xref target="items">"items"</xref>
                        ...
                        <t>If the
                            <xref target="items">"items"</xref>
                            attribute is an array (during tuple typing), then any additional items MUST be valid against
                            this schema.
                        </t>
                    </list>
                </t>
...
/Product/?name=Slinky
            ...
            <section title="contentEncoding">
                <t>If the instance property value is a string, this attribute defines that the string SHOULD be
                    interpreted as binary data and decoded using the encoding named by this schema property.
