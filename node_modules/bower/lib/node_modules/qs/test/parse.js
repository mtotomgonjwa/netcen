...
describe('parse()', function () {
    ...
    it('transforms arrays to objects (dot notation)', function (done) {
        ...
        expect(Qs.parse('foo[0].baz[0]=15&foo[0].bar=2', {allowDots: true})).to.deep.equal({
            foo: [{
                baz: ['15'],
                bar: '2'
            }]
        });
        expect(Qs.parse('foo[0].baz[0]=15&foo[0].baz[1]=16&foo[0].bar=2', {allowDots: true})).to.deep.equal({
            foo: [{
                baz: ['15', '16'],
                bar: '2'
            }]
        ...
        expect(Qs.parse('foo.bad=baz&foo[]=bar&foo[]=foo', {allowDots: true})).to.deep.equal({
            foo: {
                bad: 'baz',
                '0': 'bar',
                '1': 'foo'
        ...
        expect(Qs.parse('foo[0].a=a&foo[0].b=b&foo[1].a=aa&foo[1].b=bb', {allowDots: true})).to.deep.equal({
            foo: [{
                a: 'a',
                b: 'b'
            }, {a: 'aa', b: 'bb'}]
